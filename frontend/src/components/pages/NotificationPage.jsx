        ...
        <div className="page-wrapper">
            <div className="content-wrapper-main">
                ...
                <div className="content-view-wrapper">
                    <div className="max-width-base" style={{ height: `calc(100dvh - ${headerHeight}px)`, overflow: 'auto', padding: "40px 10px" }}>
                        
                        {/* Full Width Container */}
                        <div style={{ width: "100%" }}>
                            
                            {/* Page Header toolbar */}
                            <div className="d-flex justify-content-between align-items-center mb-4" style={{ padding: "0 10px", paddingBottom: "10px" }}>
                                <h2 className="edit-profile-header m-0" style={{ border: 0, padding: 0 }}>Notifications</h2>
                                {notifications.length > 0 && (
                                    <button className="premium-clear-btn" onClick={handleClearAll}>
                                        Clear all
                                    </button>
                                )}
                            </div>
